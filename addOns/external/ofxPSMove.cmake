...
set( NAME_ADDON     ofxPSMove )       # <--- Set the name here
...
set(OpenCV_DIR "${OF_DIRECTORY_ABSOLUTE}/addons/ofxOpenCv/libs/opencv")
find_package(OpenCV REQUIRED COMPONENTS core imgproc highgui calib3d)
target_link_libraries(${NAME_ADDON} ${OpenCV_LIBS})

target_link_libraries (${NAME_ADDON} "-lpsmoveapi" "-lpsmoveapi_tracker")
